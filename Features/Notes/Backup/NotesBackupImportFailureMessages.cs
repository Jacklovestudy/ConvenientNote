...
public sealed class UnsupportedNotesBackupSchemaException(int schemaVersion)
    : Exception($"Notes backup schema version {schemaVersion} is newer than this application supports.")
{
