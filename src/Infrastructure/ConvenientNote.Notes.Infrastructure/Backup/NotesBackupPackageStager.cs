...
internal sealed class NotesBackupPackageSnapshot : INotesBackupPackageSnapshot
{
...
public sealed class NotesBackupPackageStager : INotesBackupPackageStager
{
    async Task<INotesBackupPackageSnapshot> INotesBackupPackageStager.StageAsync(string sourcePath, CancellationToken cancellationToken) => await StageAsync(sourcePath, cancellationToken);
