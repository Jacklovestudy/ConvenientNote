...
{
    private readonly NotesApplicationService _workspaceService;
    private readonly RichTextDocumentService _documentService;
    private readonly INoteMediaService _mediaService;
    ...
    public NotesViewModel(
        NotesApplicationService workspaceService,
        RichTextDocumentService documentService,
        INoteMediaService mediaService)
    {
    ...
    public INoteMediaService MediaService => _mediaService;
